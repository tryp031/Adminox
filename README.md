...
[![Build Status](https://travis-ci.org/jonashackt/adminox.svg?branch=master)](https://travis-ci.org/jonashackt/adminox)
[![Coverage Status](https://coveralls.io/repos/github/jonashackt/adminox/badge.svg?branch=master)](https://coveralls.io/github/jonashackt/adminox?branch=master)
[![License](http://img.shields.io/:license-mit-blue.svg)](https://github.com/jonashackt/adminox/blob/master/LICENSE)
...
> **If you´re a JavaMagazin / blog.codecentric.de / Softwerker reader**, consider switching to [vue-cli-v2-webpack-v3](https://github.com/jonashackt/adminox/tree/vue-cli-v2-webpack-v3)

![localhost-first-run](screenshots/localhost-first-run.png)

A live deployment is available on Heroku: https://adminox.herokuapp.com
...
As you may already read, the app is automatically deployed to Heroku on https://adminox.herokuapp.com/.
...
All we need to do is to configure Axios in such a way inside our [frontend/src/components/http-common.js](https://github.com/jonashackt/adminox/blob/master/frontend/src/components/http-common.js):
...
```java
package co.dmazo.adminox.repository;

import co.dmazo.adminox.domain.User;
